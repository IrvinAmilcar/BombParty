        ...
        BeginDrawing();
            ...
            switch (currentGameState)
            {
                ...
                case SELECT_MODE:
                {
                    ...
                    // Removido o input de texto desta seção, pois a lógica de entrada de nome deve ser gerenciada em um estado/tela apropriado.
                    // Se você precisa da entrada de nome nesta tela, reinsira a lógica, mas gerencie 'name', 'letterCount', 'mouseOnText' e 'textBox' no escopo correto.
